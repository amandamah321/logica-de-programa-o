let pesoPeca = 200 //peso deve ser maior que 100
...
if (pesoPeca >= 100) {
  ...
  if (nomePeca.length > 2) {
    ...
    if (quantidadePecas < 10) {
      ...
      console.log(
        'Quantidade de peças excedida, não é possivel cadastrar mais peças'
      )
    }
  } else {
    console.log(
      'o nome da peça tem menos de 3 caracteres e não pode ser cadastrada'
    )
  }
} else {
